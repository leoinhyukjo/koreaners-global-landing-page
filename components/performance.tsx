  ...
  return (
    <section id="performance" className="bg-white py-24 md:py-32 lg:py-40 px-6 lg:px-24">
      <div className="max-w-7xl mx-auto">
        ...
        <h2 className="font-display font-bold text-4xl lg:text-6xl uppercase mt-4 leading-[0.9] text-[#141414] max-w-md">
        ...
        {loading ? (
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
              {portfolios.slice(0, 3).map((item) => (
                <Link key={item.id} href={`/portfolio/${item.id}`} className="group cursor-pointer">
                  <div className="aspect-video bg-[#F5F5F5] overflow-hidden border border-black/5">
                    {item.thumbnail_url ? (
                      <img
                      ...
                      <div className="w-full h-full flex items-center justify-center text-black/20 font-display font-bold text-4xl">
            ...
            <div className="mt-12 text-center">
              <Link
                href="/portfolio"
                className="text-sm uppercase tracking-wider font-bold text-[#141414] border-b border-black/30 hover:border-black pb-1 transition-colors duration-300"
              >
