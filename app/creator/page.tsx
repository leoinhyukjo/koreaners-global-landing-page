...
export const metadata: Metadata = {
  ...
  description:
    '코리너스의 300+ 전속 크리에이터를 만나보세요. 뷰티, 패션, F&B, 라이프스타일 등 다양한 카테고리의 검증된 인플루언서 네트워크.',
  alternates: { canonical: `${siteUrl}/creator` },
  openGraph: {
    title: '코리너스 크리에이터 | 전속 인플루언서 네트워크',
    description: '300+ 전속 크리에이터. 뷰티, 패션, F&B 등 카테고리별 검증된 인플루언서.',
    url: `${siteUrl}/creator`,
  },
}
