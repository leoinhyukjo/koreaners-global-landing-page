...
export const metadata: Metadata = {
  title: '코리너스 | 크로스보더 인플루언서 마케팅 전문 에이전시',
  description: '크로스보더 인플루언서 마케팅 전문 에이전시 코리너스. 300+ 브랜드, 300+ 전속 크리에이터, 5,000+ 체험단. 인플루언서 캠페인, 대량 시딩, 콘텐츠 제작, 데이터 리포팅까지 크로스보더 마케팅 전 과정을 운영합니다.',
  ...
  return (
    <main className="min-h-screen bg-background w-full max-w-full overflow-x-hidden">
      ...
      <div className="sr-only" aria-hidden="false">
        <h1>코리너스 — 크로스보더 인플루언서 마케팅 전문 에이전시</h1>
        <p>
          코리너스(KOREANERS)는 크로스보더 인플루언서 마케팅 전문 에이전시입니다.
        ...
        <h2>크로스보더 인플루언서 마케팅 서비스</h2>
        <ul>
          <li>인플루언서 마케팅 — 전속 크리에이터 네트워크를 통한 캠페인 기획 및 운영. 나노~메가 티어 맞춤 섭외.</li>
