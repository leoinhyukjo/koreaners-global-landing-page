...
export const metadata: Metadata = {
  ...
  description: '크로스보더 인플루언서 마케팅 전문 대행사 코리너스. 70+ 브랜드, 200+ 주요 크리에이터, 5,000+ 체험단. 인플루언서 캠페인, 대량 시딩, 콘텐츠 제작, 데이터 리포팅까지 크로스보더 마케팅 전 과정을 운영합니다.',
  ...
  return (
    <main className="min-h-screen bg-background w-full max-w-full overflow-x-hidden">
      ...
      <div className="sr-only" aria-hidden="false">
        ...
        <p>70+ 브랜드 지원 | 200+ 주요 크리에이터 | 5,000+ 체험단 | 30만+ SNS 커뮤니티 | 평균 ROI 250%</p>
