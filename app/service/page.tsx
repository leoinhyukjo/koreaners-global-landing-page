...
export const metadata: Metadata = {
  ...
  description:
    '일본 인플루언서 마케팅, 대량 시딩, 콘텐츠 제작, 데이터 리포팅까지. 200+ 주요 크리에이터 네트워크. 코리너스의 크로스보더 마케팅 서비스를 확인하세요.',
...
export default function ServicePage() {
  ...
  const service = {
    ...
    description:
      '일본 인플루언서 마케팅, 대량 시딩, 콘텐츠 제작, 데이터 리포팅까지. 200+ 주요 크리에이터 네트워크로 한국 브랜드의 일본 진출을 설계합니다.',
    url: `${siteUrl}/service`,
